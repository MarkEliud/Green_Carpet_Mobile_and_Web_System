...
public class activityDetails extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.childcare_detail, container, false);

        return v;
    }

    private void updateActivity(final String name,final String time,final String activity) {
        //if (phone.length() == 10) {
