...
public class supplyApprove extends Fragment {

    //private static final String URL_PRODUCTS = "http://"+ LoginActivity.ip+"/bdcms/admin/recyclerview/pending.php";
    public static final String URL_PRODUCTS = LoginActivity.ip+"recyclerview/supplyfapprove.php";
    List<Image> productList;
    RecyclerView recyclerView;
    public supplyApprove() {
    }
    //String email;
