...
public class supplyApproveAdapterA extends RecyclerView.Adapter<supplyApproveAdapterA.ProductViewHolder> {
    ...
    public supplyApproveAdapterA(Context mCtx, List<Image> productList) {
        this.mCtx = mCtx;
