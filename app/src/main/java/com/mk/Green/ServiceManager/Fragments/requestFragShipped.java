...
import com.mk.Green.Finance.Adapters.supplyApproveAdapter;
...
public class requestFragShipped extends Fragment {

    //private static final String URL_PRODUCTS = "http://"+ LoginActivity.ip+"/bdcms/admin/recyclerview/pending.php";
    public static final String URL_PRODUCTS = LoginActivity.ip+"recyclerview/displaysupplyA.php";
    List<Image> productList;
    RecyclerView recyclerView;
    public requestFragShipped() {
    }
    //String email;
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                productList.add(new Image(
                                        ...
                                        jsonObject.getString("investatus")
                                ));
                            }

                            //creating adapter object and setting it to recyclerview
                            supplyApproveAdapter adapter = new supplyApproveAdapter(getActivity(), productList);
