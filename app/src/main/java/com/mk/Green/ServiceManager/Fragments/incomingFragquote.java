...
import com.mk.Green.ServiceManager.Adapters.incomingAdapterquote;
...
public class incomingFragquote extends Fragment {

    //private static final String URL_PRODUCTS = "http://"+ LoginActivity.ip+"/bdcms/admin/recyclerview/pending.php";
    public static final String URL_PRODUCTS =LoginActivity.ip+ "recyclerview/display.php";
    List<Image> productList;
    RecyclerView recyclerView;
    public incomingFragquote() {
    }
    //String email;
...
//
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            incomingAdapterquote adapter = new incomingAdapterquote(getActivity(), productList);
    ...
    private void filter(String text) {
        ...
        incomingAdapterquote adapter = new incomingAdapterquote(getActivity(), filteredList);
        recyclerView.setAdapter(adapter);
    }
}