...
//        }
        if(!amount.equals("null")){
           ...
           // Toast.makeText(getActivity(), "cannot approve until customer pays", Toast.LENGTH_SHORT).show();
            approve.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    //updateStatus1(description,"Approved");
                    Toast.makeText(getActivity(), "Only finance will approve", Toast.LENGTH_SHORT).show();
                }
            });
            reject.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(getActivity(), "Only finance will reject", Toast.LENGTH_SHORT).show();
