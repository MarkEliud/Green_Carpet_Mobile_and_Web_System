...
import com.mk.Green.ServiceManager.Adapters.incomingAdapter;
...
public class incomingFrag extends Fragment {
    ...
    //   Toast.makeText(getActivity(), "heyy", Toast.LENGTH_SHORT).show();


        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_PRODUCTS+"?category="+"all",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            incomingAdapter adapter = new incomingAdapter(getActivity(), productList);
