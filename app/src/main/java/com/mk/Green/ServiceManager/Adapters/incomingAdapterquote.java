...
import com.mk.Green.ServiceManager.Fragments.incomingDetailsquote;
...
public class incomingAdapterquote extends RecyclerView.Adapter<incomingAdapterquote.ProductViewHolder> {
    ...
    public incomingAdapterquote(Context mCtx, List<Image> productList) {
        this.mCtx = mCtx;
        ...
        holder.c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               // Toast.makeText(mCtx, email, Toast.LENGTH_SHORT).show();
                ...
                incomingDetailsquote fragB = new incomingDetailsquote();
