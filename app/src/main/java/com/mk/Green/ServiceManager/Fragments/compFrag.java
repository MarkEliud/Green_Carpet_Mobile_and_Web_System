...
import com.mk.Green.ServiceManager.Adapters.SupIncomingAdapter;
import com.mk.Green.ServiceManager.Adapters.compAdapter;
...
public class compFrag extends Fragment {

    private static final String URL_PRODUCTS =LoginActivity.ip+ "recyclerview/displaycompleted.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            compAdapter adapter = new compAdapter(getActivity(), productList);
