...
import com.mk.Green.Supervisor.Fragments.SupDetails;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;
import java.util.List;

public class SupIncomingAdapter extends RecyclerView.Adapter<SupIncomingAdapter.ProductViewHolder> {
    ...
    public SupIncomingAdapter(Context mCtx, List<Image> productList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(ProductViewHolder holder, int position) {
        Image image = filteredList.get(position);
        ...
        holder.c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              ///  if(Objects.equals(product.getCaretype(), "long")){
                ...
                b.putString("name", image.getCustomerName());
       ...
       // Image image = images.get(position);
        holder.nameTextView.setText("Item Name: "+image.getName());
