...
import com.mk.Green.Supervisor.Adapters.SupIncomingAdapter;
...
public class incomingSupFrag extends Fragment {

    private static final String URL_PRODUCTS =LoginActivity.ip+ "recyclerview/displayApproved.php";
   ...
   //String email;
    ...
    private void filter(String text) {
        ...
        SupIncomingAdapter adapter = new SupIncomingAdapter(getActivity(), filteredList);
