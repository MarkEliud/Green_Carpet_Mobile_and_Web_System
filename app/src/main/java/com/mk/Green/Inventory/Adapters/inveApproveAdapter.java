...
import com.mk.Green.Inventory.Fragments.inveincomingDetails;
import com.mk.Green.R;
import com.mk.Green.Supplier.Fragments.incomingDetailsup;

import java.util.List;

public class inveApproveAdapter extends RecyclerView.Adapter<inveApproveAdapter.ProductViewHolder> {
    ...
    public inveApproveAdapter(Context mCtx, List<Image> productList) {
        this.mCtx = mCtx;
       ...
       holder.fprice.setVisibility(View.GONE);
        ...
        holder.c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                inveincomingDetails fragB = new inveincomingDetails();
