...
import com.mk.Green.Inventory.Fragments.allocateDetails;
...
public class allocateAdapter extends RecyclerView.Adapter<allocateAdapter.ProductViewHolder> {
    ...
    public allocateAdapter(Context mCtx, List<Image> productList) {
        this.mCtx = mCtx;
        ...
        holder.c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               // Toast.makeText(mCtx, email, Toast.LENGTH_SHORT).show();
                ...
                allocateDetails fragB = new allocateDetails();
