...
import com.mk.Green.Inventory.Adapters.inveApproveAdapter;
...
public class inveApprove extends Fragment {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            inveApproveAdapter adapter = new inveApproveAdapter(getActivity(), productList);
