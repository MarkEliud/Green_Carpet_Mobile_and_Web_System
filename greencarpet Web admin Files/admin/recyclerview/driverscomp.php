<?php 
  ...
  $email = $_GET['email'];
 //creating a query
 $stmt = $con->prepare("SELECT id,date, name, description, image,customerName,address,amount,status,code,fprice,email,assignee, assigneeDriver,cleanername FROM orders WHERE assigneeDriver='$email' AND dstatus='Completed';");
