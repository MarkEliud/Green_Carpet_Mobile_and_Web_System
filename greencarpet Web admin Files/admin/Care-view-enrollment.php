...
if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update   tbldriver set  status='$ressta' where id='$viewid'");
    if ($query) {
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php
 $viewid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from tbldriver where tbldriver.id='$viewid'");
$cnt=1;
...
<td colspan="4" style="font-size:20px;color:blue">
 View Drivers Details of (<?php  echo $row['fullname'];?>)</td></tr>
