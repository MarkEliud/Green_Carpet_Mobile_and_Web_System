...
<head>
  ...
  <title>Green Carpet Cleaning | Dashboard</title>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
<?php $query=mysqli_query($con,"select id from tblcleaner");
...
?>               
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
<?php $query2=mysqli_query($con,"select ID from tblcustomer where Status is null");
...
?>
              ...
              <a href="all-enrollment.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
<?php $query2=mysqli_query($con,"select ID from tblcustomer where Status='Accepted'");
...
?>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
<?php $query2=mysqli_query($con,"select ID from tblcustomer where Status='Onhold'");
$onholdenroll=mysqli_num_rows($query2);
?>

                <h3><?php echo $onholdenroll;?></h3>

                <p>Onhold Customers</p>
              </div>
              <div class="icon">
                <i class="ion ion-person-add"></i>
              </div>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
 <?php $query2=mysqli_query($con,"select ID from tblcustomer where Status='Rejected'");
